...
namespace osc {
  ...
  extern "C" int main(int ac, char **av)
  {
    try {
      ...
      model[0].color = vec3f(0.8f, 0.4f, 0.01f);
      model[0].addCube(vec3f(0.f,-1.5f, 0.f),vec3f(10.f,.1f,10.f));
      model[0].material = vec3f(2.0f, 0.3f, 0.0f);
      // a unit cube centered on top of that
      model[1].color = vec3f(0.95f,0.15f,0.95f);
      model[1].addCube(vec3f(0.f,0.f,0.f),vec3f(2.f,2.f,2.f));
      model[1].material = vec3f(2.0f, 0.7f, 0.0f);
      // thin light source
      model[2].color = vec3f(4.0f,4.0f,4.0f);
      model[2].addCube(vec3f(7.f,1.f,0.f),vec3f(0.05f,2.f,2.f));
      model[2].material = vec3f(3.0f, 0.0f, 0.0f);
