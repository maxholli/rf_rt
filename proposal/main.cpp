...
int main()
{
    ...
    switch (0)
    {
        case 0:
            ...
            // above RX building
            // lookfrom = point3(20,65,20);
            // lookat = point3(20,2,60);
            
            // centered overall from west
            lookfrom = point3(145,200,-20);
            lookat = point3(145,-30,105);
            // centered rays
            lookfrom = point3(85,130,15);
            lookat = point3(85,-30,105);
            vfov = 56.0;
